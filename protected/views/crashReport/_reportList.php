        ...
        <ul class="dropdown-menu">
            <li><a href="#">Other Actions...</a>
                <ul>
                    ...
                    <?php
                    if(Yii::app()->user->checkAccess('pperm_manage_crash_reports', array('project_id'=>Yii::app()->user->getCurProjectId())))
	                    echo '<li>'.CHtml::linkButton("Delete All Reports Of Current Version",
			                    array(
				                    'submit'=>$this->createUrl('crashReport/deleteAllByVer', isset($groupid)?array('groupid'=>$groupid):array()),
				                    'form'=>'del_form',
				                    'confirm'=>"Are you sure you want to permanently delete all crash reports of the current version? (data will be deleted at background mode)"
			                    )).'</li>';
                    ?>
                    <?php
                    if(Yii::app()->user->checkAccess('pperm_manage_crash_reports', array('project_id'=>Yii::app()->user->getCurProjectId())))
	                    echo '<li>'.CHtml::linkButton("Pack Reports Files Of Current Version",
			                    array(
				                    'submit'=>$this->createUrl('crashReport/packAllByVer', isset($groupid)?array('groupid'=>$groupid):array()),
				                    'form'=>'del_form',
